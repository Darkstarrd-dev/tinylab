...
> 依据：最近提交 `06101fa`（2026-08-04 初始实现）→ `a2933c5`（08-05 retry export 修复）→ `09ee6dc`（08-10 JSON 容错/模板可编辑/仓鼠加载）→ `0a0028d`（08-11 工作流修复）及当前代码事实基线
> 本文只描述流程、提示词与结果契约，不涉及具体代码实现
