...
>
> **变更维护：** 涉及文档——`PROJECT_MAP.md` §18.2/§24、`gif_upgrade.md`（zoom 范围 50%–200%→20%–300%）、`docs/playground-architecture.md`（§14 源码锚点 + MediaBridge 投递 + `/edit/upload-temp|zip-outputs` 契约行）、`docs/archive-architecture.md`（§7/§8/§11 MediaBridge 与 GIF 生产者）。
>
...
>
> **变更维护：** 涉及文档——`PROJECT_MAP.md` §18.2/§24、`gif_upgrade.md`（§4.1 状态表 + script 顺序 + node --check 清单）。
>
