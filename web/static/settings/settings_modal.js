...
function openPathModal() {
  openPathSettingsModal({ title: t('pathSettings'), sections: { defaultDir: true, docDir: true, imageDir: true, logDir: true, gamesDir: true, musicDir: true, storyDir: true, ytDlpPath: true, ffmpegPath: true } });
}
