    ...
    TD.Sfx = (function () {
      ...
      return {
        play: function (name) {
          ...
          else if (name === 'victory') { tone(523, 0.2, 'sine', 0.2); setTimeout(function(){ tone(659,0.2,'sine',0.2); },140); setTimeout(function(){ tone(784,0.35,'sine',0.22); },300); }
